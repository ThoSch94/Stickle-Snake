...
log_file = r"E:\Initial_Alaska_Training\log.json"

# path where the images are stored
image_dir = r"E:\Initial_Alaska_Training\combined/"
    ...
    for id, file in enumerate(os.listdir(image_dir)):
        ...
        if file.endswith(('.jpg', '.JPG', ".NEF")):
            ...
            # check if only one label is detected
                ...
                if rename:
                    os.rename(f"{image_path}/{image_dir}/{most_frequent_label}.jpg")
...
if __name__ == "__main__":
    main(log_file = log_file, image_dir = image_dir, flip = flip, pattern = pattern, rename =  rename)
