...
out_dir = "/data/Fish_photos/Fish_photos_2021_unsorted/cropped/"
# where is your pipeline config located
pipeline_config_path = "/data/rp_files/rp/Stickleback_detection_model/pipeline.config"
# Label file
label_path = "/data/rp_files/rp/Stickleback_detection_model/label_map.pbtxt"
# where is your checkpoint located
checkpoint_path = "/data/rp_files/rp/Stickleback_detection_model/"
# checkpoint basename
checkpoint = 'ckpt-5'
# should the bounding box coordinates be saved?
save_bbox_coordinates = True 
# should the image be flipped (180° rotation) before detection?
flip = True
